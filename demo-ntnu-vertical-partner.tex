...
\partnerlogos{images/ntnu_partner.png}{images/ntnu_partner_vert_neg.png}
%
...
\begin{document}
	...
	\begin{frame}[fragile]{A slide in \texttt{vertical} style including a partner logo}
		...
		\lstinline!\partnerlogos{images/ntnu_partner.png}{images/ntnu_partner_vert_neg.png}!

		The \texttt{vertical} style displays the second logo of the
		collaboration partner (\lstinline!images/ntnu_partner_vert_neg.png!,
		preferable white/light colors and upright/rotated) in the
		sidebar while the first logo (\lstinline!images/ntnu_partner.png!) is
